  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      icons: {
        ...
        'align-center': 'note-icon-align-center',
        'align-indent': 'note-icon-align-indent',
        'align-justify': 'note-icon-align-justify',
        'align-left': 'note-icon-align-left',
        'align-outdent': 'note-icon-align-outdent',
        'align-right': 'note-icon-align-right',
        'arrows-alt': 'note-icon-arrows-alt',
        'bold': 'note-icon-bold',
        'caret': 'note-icon-caret',
        'chain-broken': 'note-icon-chain-broken',
        ...
        'menu-check': 'note-icon-menu-check',
        'minus': 'note-icon-minus',
        'orderedlist': 'note-icon-orderedlist',
        'pencil': 'note-icon-pencil',
        'picture': 'note-icon-picture',
        'popup-close': 'note-icon-popup-close',
        'question': 'note-icon-question',
        'redo': 'note-icon-redo',
        'special-character': 'note-icon-special-character',
        'square': 'note-icon-square',
        'strikethrough': 'note-icon-strikethrough',
        'subscript': 'note-icon-subscript',
        'superscript': 'note-icon-superscript',
        'table': 'note-icon-table',
        'text-height': 'note-icon-text-height',
